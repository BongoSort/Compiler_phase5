...
let rec statement_to_tree c =
  ...
  | ReturnStm {ret = Some ret ; _} -> PBox.hlist ~bars:false [make_keyword_line "ReturnValStm: "; expr_to_tree ret]
  | ReturnStm {ret = None; _} -> PBox.hlist ~bars:false [make_keyword_line "ReturnValStm: ";]
